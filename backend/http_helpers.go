...
func (h *HTTPHelper) GetRequestMethod(request network.HTTPRequest) string {
	return request.Method()
}

// GetRequestURL extracts the full URL from an HTTPRequest
func (h *HTTPHelper) GetRequestURL(request network.HTTPRequest) string {
	return request.URL()
}

// GetRequestHeaders extracts headers from an HTTPRequest
func (h *HTTPHelper) GetRequestHeaders(request network.HTTPRequest) map[string]string {
	return request.Headers()
}

// GetRequestBody extracts the body from an HTTPRequest
func (h *HTTPHelper) GetRequestBody(request network.HTTPRequest) string {
	return string(request.Body())
}

// GetRequestHost extracts the host from an HTTPRequest
func (h *HTTPHelper) GetRequestHost(request network.HTTPRequest) string {
	return request.Host
}

// GetRequestTLS returns whether the request uses TLS
func (h *HTTPHelper) GetRequestTLS(request network.HTTPRequest) bool {
	return request.TLS
}
...
func (h *HTTPHelper) GetResponseStatus(response network.HTTPResponse) string {
	return response.Status()
}

// GetResponseStatusCode extracts the status code from an HTTPResponse
func (h *HTTPHelper) GetResponseStatusCode(response network.HTTPResponse) int {
	return response.StatusCode()
}

// GetResponsePrintable extracts the printable content from an HTTPResponse
func (h *HTTPHelper) GetResponsePrintable(response network.HTTPResponse) string {
	return response.Printable()
}

// GetResponseHeaders extracts headers from an HTTPResponse (if we add this method later)
func (h *HTTPHelper) GetResponseHeaders(response network.HTTPResponse) map[string]string {
...
func (h *HTTPHelper) FormatRequestSummary(request network.HTTPRequest) string {
	return request.Method() + " " + request.URL()
}

// FormatResponseSummary creates a summary string for a response
func (h *HTTPHelper) FormatResponseSummary(response network.HTTPResponse) string {
	return response.Status()
}
