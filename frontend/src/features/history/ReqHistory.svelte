<script lang="ts">
  ...
  import { GetProxyRequests, GetProxyRequestsAfter, GetTransactionDetails, SearchProxyRequests, GetTransactionMetadata, GetTransactionChunk } from '../../../wailsjs/go/backend/App';
